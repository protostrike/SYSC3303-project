...
public class ElevatorSubsystem {
	 ...
	 * 
	 * @param portNumber
	 * @param numberOfElevators - number of elevator cars in our system
	 */
	public ElevatorSubsystem(int portNumber,int numberOfElevators) {}
	...
	/**
	 * 
	 *  send an elevator's status to the elevator
	 * 
	 */
	...
	/**
	 * THIS IS WHERE THE ELEVATOR STARTS THREADS
	 * @param args
	 */
	public static void main(String args[]){
		...
		//a = new Thread (new Elevator(portNumber,"ElevatorName"),"Thread_Label")
		//b = new Thread (new Elevator(portNumber,"ElevatorName"),"Thread_Label")
		//c = new Thread (new Elevator(portNumber,"ElevatorName"),"Thread_Label")
		//d = new Thread (new Elevator(portNumber,"ElevatorName"),"Thread_Label")
