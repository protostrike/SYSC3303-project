...
public class FloorSubsystem {
	...
	public synchronized void start() {
		...
		//	if(requests.getFirst().getTimes().SECOND== (int)(duration/100)
			//		&& requests.getFirst().getTimes().MINUTE == (int)(duration/6000)
				//	&& requests.getFirst().getTimes().HOUR_OF_DAY == (int)(duration/360000))
			//{
