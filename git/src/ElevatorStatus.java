...
public class ElevatorStatus implements Serializable{
	...
	public int getFarthestDestination() {
		if(up) {
			int count = 0;
			for(Person p : carList) {
				if(p.destFloor >= count)
					count = p.destFloor;
			}
			return count;
		}
	...
	/**
	 * getWorkingStatus() gets the working status of the elevator
	 * 
	 * @param workingStatus - whether elevator is working well or shut down because of error
	 * @return 
	 */
	...
	/**
	 * setWorkingStatus() sets the working status of the elevator
	 * 
	 * @param workingStatus - whether elevator is working well or shut down because of error
	 * @return 
	 */
